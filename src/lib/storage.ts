const KEYS = {
  ...
  expenseTemplates: "kkn:expenseTemplates",
  fields: "kkn:fields",
...
export const storage = {
  ...
  getExpenseTemplates: () => safeGet(KEYS.expenseTemplates, [] as unknown[]),
  setExpenseTemplates: (v: unknown) => safeSet(KEYS.expenseTemplates, v),
  getFields: () => safeGet(KEYS.fields, [] as unknown[]),
  setFields: (v: unknown) => safeSet(KEYS.fields, v),
